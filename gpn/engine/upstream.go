...
func SetUpstreamDialer(dial func(ctx context.Context, host string, port int) (net.Conn, error)) {
	dialUpstream = func(ctx context.Context, t netTarget) (net.Conn, error) {
		return dial(ctx, t.Host, t.Port)
	}
}
...
func SetUpstreamPacketDialer(listen func(ctx context.Context, host string, port int) (net.PacketConn, error)) {
	listenPacketUpstream = func(ctx context.Context, t netTarget) (net.PacketConn, error) {
		return listen(ctx, t.Host, t.Port)
	}
}
